      ...
      <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
          <ul class="nav navbar-nav side-nav">
            <li class="active"><a href="menuAdministrador.php"><i class="fa fa-dashboard"></i>Resumen</a></li>
            <li><a href="reportes.php"><i class="fa fa-bar-chart-o"></i>Reportes</a></li>
          </ul>
        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <div class="alert alert-success alert-dismissable">
              ...
              A continuación encontrará un resumen del estado de las encuestas.
            </div>
          </div>
        </div><!-- /.row -->
              ...
              <div class="panel-heading">
                <div class="row">
                  ...
                  <div class="col-xs-6 text-right">
                    ...
                    <p class="announcement-text">Encuestados</p>
                  </div>
                </div>
              </div>
              <a href="#">
              ...
              <div class="panel-heading">
                <div class="row">
                  ...
                  <div class="col-xs-6 text-right">
                    ...
                    <p class="announcement-text">Encuestas hoy</p>
                  </div>
                </div>
              </div>
              <a href="#">
              ...
              <div class="panel-heading">
                <div class="row">
                  ...
                  <div class="col-xs-6 text-right">
                    ...
                    <p class="announcement-text">Encuestas Restantes</p>
                  </div>
                </div>
              </div>
              <a href="#">
              ...
              <div class="panel-heading">
                <div class="row">
                  ...
                  <div class="col-xs-6 text-right">
                    ...
                    <p class="announcement-text">Encuestas en Proceso</p>
                  </div>
                </div>
              </div>
              <a href="#">
